...
class Collections
{
	...
	public static function getIconAuthor($author)
	{
		switch($author){
			case 'goon':
				$return_author = '<img src="/elleair/images/news/icon03.png" style="height:15px;">';
				break;
			case 'elis':
				$return_author = '<img src="/elleair/images/news/icon01.png" style="height:15px;">';
				break;
			case 'elleair':
				$return_author = '<img src="/elleair/images/news/icon02.png" style="height:15px;">';
				break;
			default:
				$return_author = '';
		}
