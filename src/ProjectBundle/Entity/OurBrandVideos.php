 ...
 * OurBrandVideos
 *
 * @ORM\Table(name="our_brand_videos")
 * @ORM\Entity(repositoryClass="ProjectBundle\Repository\OurBrandVideosRepository")
 * @ORM\HasLifecycleCallbacks
 */
class OurBrandVideos
{
    /**
     * @var int
     *
    ...
    */
    ...
    /**
    * @ORM\ManyToOne(targetEntity="OurBrand", inversedBy="ourBrandVideos")
    * @ORM\JoinColumn(name="our_brand_video_id", referencedColumnName="id")
    */
    private $ourBrand;
    ...
    */
    ...
    /**
     * Get the value of Our Brand
     *
     * @return mixed
     */
    public function getOurBrand()
    {
        return $this->ourBrand;
    }

    /**
     * Set the value of Our Brand
     *
     * @param mixed ourBrand
     *
     * @return self
     */
    public function setOurBrand($ourBrand)
    {
