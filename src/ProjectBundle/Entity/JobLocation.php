 ...
 * JobLocation
 *
 * @ORM\Table(name="job_location")
 * @ORM\Entity(repositoryClass="ProjectBundle\Repository\JobLocationRepository")
...
class JobLocation
{
    ...
    */
    ...
    /**
     * @ORM\OneToMany(targetEntity="Jobs", mappedBy="jobLocation")
     */
    private $jobs;
