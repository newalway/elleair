 ...
 * OtherSkill
 *
 * @ORM\Table(name="other_skill")
 * @ORM\Entity(repositoryClass="ProjectBundle\Repository\OtherSkillRepository")
...
class OtherSkill
{
    ...
    /**
    * @ORM\ManyToOne(targetEntity="ApplyJobs", inversedBy="otherSkill")
