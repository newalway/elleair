...
class News
{
	...
	*/
    ...
    // /**
    // * @ORM\ManyToOne(targetEntity="OurBrand", inversedBy="news")
    // * @ORM\JoinColumn(name="our_brand_id", referencedColumnName="id")
    // */
    // private $ourBrand;
	...
	*/
    ...
    {
        $this->newsCategorys = new ArrayCollection();
     ...
     *
     * @param mixed newsCategorys
     *
     * @return self
     */
    public function setNewsCategorys($newsCategorys)
    {
