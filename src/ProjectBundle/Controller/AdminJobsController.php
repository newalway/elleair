...
use ProjectBundle\Form\Type\AdminJobsType;
...
class AdminJobsController extends Controller
{
	...
	*/
	public function newAction(Request $request)
	{
		...
		$data = new Jobs();
		$form = $this->createForm(AdminJobsType::class, $data);
	...
	*/
	public function editAction(Request $request)
	{
		...
		$data = $this->getDoctrine()->getRepository(Jobs::class)->find($request->get('id'));
	...
	*/
	public function deleteAction(Request $request)
	{
		...
		$data = $em->getRepository(Jobs::class)->find($request->get('id'));
		if (!$data) { throw $this->createNotFoundException('No data found'); }
	...
	public function group_deleteAction(Request $request)
	{
		...
		if ($data_ids) {
			...
			foreach ($data_ids as $data_id) {
				$data = $em->getRepository(Jobs::class)->find($data_id);
				if ($data) {
					try {
						$em->remove($data);
				    $em->flush();
