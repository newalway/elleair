...
class AdminNewsType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('newsCategorys', EntityType::class, array(
        ...
        //             'choices' => array( 'Please choose author' => NULL,'GOO.N' => 'goon', 'Elis' => 'elis','Elleair'=> 'elleair'),
        //             // 'expanded' => true,
        //             // 'multiple' => false,
        //             'attr'=>array('class' => 'form-control'),
        //             'constraints' => array(
        //                 new NotBlank(array('message' => '*** Please choose Author')))
        // ));

        // $builder->add('ourBrand', EntityType::class, array(
        //     'attr'=>array('class'=>'form-control'),
        //     'label_attr' => array('class' => ''),
        //     'required' => false,
        //     // query choices from this entity
        //     'class' => OurBrand::class,
        //     // 'query_builder' => function (EntityRepository $er) {
        ...
        //     // use the User.username property as the visible option string
        //
        //     'choice_label' => function ($categoty ,$key,$value) {
        //
        //       return $categoty->getTitle();
        //     },
        //     // 'choice_label' => 'translations['.$local.'].title',
        //     // 'choice_label' => 'title',
        //     // used to render a select box, check boxes or radios
