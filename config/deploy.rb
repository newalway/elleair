...
set :application, "elleair"
set :repo_url, "ssh://git@128.199.130.27:/home/git/git-repo/elleair.git"
...
append :linked_dirs, 'web/uploads', 'web/media', 'data/banks', 'data/excel', 'var/browscapcache', 'var/sessions', 'join-us'
